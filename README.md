...
**F7** edição de lançamentos & recorrências · **F8** mobile (gaveta de navegação) & PWA instalável · **F9** busca & filtros no histórico completo · **F10** importação OFX com dedup.
